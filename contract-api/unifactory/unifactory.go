...
func (_Unifactory *UnifactoryCaller) Migrator(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Unifactory.contract.Call(opts, &out, "migrator")
...
//
// Solidity: function migrator() view returns(address)
func (_Unifactory *UnifactorySession) Migrator() (common.Address, error) {
	return _Unifactory.Contract.Migrator(&_Unifactory.CallOpts)
}

// Migrator is a free data retrieval call binding the contract method 0x7cd07e47.
//
// Solidity: function migrator() view returns(address)
func (_Unifactory *UnifactoryCallerSession) Migrator() (common.Address, error) {
	return _Unifactory.Contract.Migrator(&_Unifactory.CallOpts)
}
...
func (_Unifactory *UnifactoryCaller) PairCodeHash(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Unifactory.contract.Call(opts, &out, "pairCodeHash")
...
//
// Solidity: function pairCodeHash() pure returns(bytes32)
func (_Unifactory *UnifactorySession) PairCodeHash() ([32]byte, error) {
	return _Unifactory.Contract.PairCodeHash(&_Unifactory.CallOpts)
}

// PairCodeHash is a free data retrieval call binding the contract method 0x9aab9248.
//
// Solidity: function pairCodeHash() pure returns(bytes32)
func (_Unifactory *UnifactoryCallerSession) PairCodeHash() ([32]byte, error) {
	return _Unifactory.Contract.PairCodeHash(&_Unifactory.CallOpts)
}
...
func (_Unifactory *UnifactoryTransactor) SetMigrator(opts *bind.TransactOpts, _migrator common.Address) (*types.Transaction, error) {
	return _Unifactory.contract.Transact(opts, "setMigrator", _migrator)
}

// SetMigrator is a paid mutator transaction binding the contract method 0x23cf3118.
//
// Solidity: function setMigrator(address _migrator) returns()
func (_Unifactory *UnifactorySession) SetMigrator(_migrator common.Address) (*types.Transaction, error) {
	return _Unifactory.Contract.SetMigrator(&_Unifactory.TransactOpts, _migrator)
}

// SetMigrator is a paid mutator transaction binding the contract method 0x23cf3118.
//
// Solidity: function setMigrator(address _migrator) returns()
func (_Unifactory *UnifactoryTransactorSession) SetMigrator(_migrator common.Address) (*types.Transaction, error) {
	return _Unifactory.Contract.SetMigrator(&_Unifactory.TransactOpts, _migrator)
}
